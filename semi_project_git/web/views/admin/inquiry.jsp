...
<html lang="en">
  ...
  <body>
    <section>
      <form action="<%=request.getContextPath()%>/admin/InquiryEnd" name="" method="post">
        <div>
          <ul>
        ...
        <div name="request_table" id="request-table">
          <table border="1">
            ...
            <tr>
              <td>문의 내용</td>
              <td>
                <textarea rows="15" cols="60" name="inqContent" placeholder="문의내용을 입력해주세요" onKeyUp="javascript:fnChkByte(this,'1000')"></textarea>
